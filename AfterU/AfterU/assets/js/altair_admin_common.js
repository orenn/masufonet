...
// 3. Common functions & variables
    ...
    altair_forms = {
        ...
        textarea_autosize: function () {
            ...
            //debugger
            //var text = $('#txtDetails_2961972').val(); 
    ...
    altair_helpers = {
                    ...
                    if(thisChildrenLength >= 1) {
                        ...
                        $this.waypoint({
                            handler: function() {
                                ...
                                }, (thisChildrenLength * baseDelay) + 1200 );// צחי שינה
                                this.destroy();
                            },
                            context: thisContext,
                            offset: '90%'
        ...
        content_preloader_show: function(style,variant,container,width,height) {
            ...
            if(!$body.find('.content-preloader').length) {
                ...
                thisContainer.append('<div class="content-preloader '+_variant+'" style="height:'+height+'px;width:'+width+'px;margin-right:-'+width/2+'px">' + preloader_content + '</div>');
                setTimeout(function() {
